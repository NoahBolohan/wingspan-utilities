function assign_submit_href() {
    ...
    var data_dict = {
        ...
        "col_birds_of_canada_checkbox" : $("#col_birds_of_canada_checkbox").is(":checked"),
        "col_birds_of_new_zealand_checkbox" : $("#col_birds_of_new_zealand_checkbox").is(":checked"),
        "col_birds_of_the_usa_checkbox" : $("#col_birds_of_the_usa_checkbox").is(":checked"),
        "col_british_birds_checkbox" : $("#col_british_birds_checkbox").is(":checked"),
        "col_birds_of_continental_europe_checkbox" : $("#col_birds_of_continental_europe_checkbox").is(":checked"),
        "col_additional_asian_avians_checkbox" : $("#col_additional_asian_avians_checkbox").is(":checked"),
